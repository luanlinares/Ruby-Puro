#ENUNCIADO
  # Em uma classe chamada Carro, crie um método público chamado 
  #get_km que recebe como parâmetro a seguinte informação “Um fusca de cor amarela viaja a 80km/h ”.
